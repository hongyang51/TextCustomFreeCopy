...
public class SelectableTextHelper {
    ...
    private boolean isShow() {
        return mSelectionInfo.mSelectionContent != null || mSpannable != null || mSpan != null;
    }
...
//                ViewParent parent = mTextView.getParent();
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context) {
            View contentView = LayoutInflater.from(context).inflate(R.layout.layout_operate_windows01, null);
            ...
            contentView.findViewById(R.id.tv_copy_01).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
